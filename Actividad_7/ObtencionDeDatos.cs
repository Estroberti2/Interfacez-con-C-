...
{
	public class LectorDeArchivos : ChainOfResponsability
	{
		
		// El alumno deberá agregar la ruta correspondiente a su equipo donde haya guardado el archvo con los datos
		private const string ruta_archivo = @"C:\Users\almma\Desktop\Actividad_7\datos.txt";
			//@"C:\Users\almma\Desktop\Actividad_7\datos.txt";
		// --------------------------------------------------------------------------------------------------------
		
		private StreamReader lector_de_archivos;
		
		public LectorDeArchivos(ChainOfResponsability s):base(s){
